...
3. smooth data_y with a median filter (you may use a kernel size of, e.g.
   7 points).  Plot the filtered data (with dashed lines) superimposed to data_y
   and data_y0.
...
- See numpy.arange(), numpy.randn() --or even better, np.random.normal()--
